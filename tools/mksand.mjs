...
const OCT=[16,32,64,128];         // cells across, per octave — every one divides N
const AMP=[0.34,0.30,0.24,0.16];
...
writeFileSync(process.argv[2]||'/home/user/Surf-/models/sandgrain.png',png);
