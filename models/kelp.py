import bpy, os, sys
SRC="/root/.claude/uploads/7480d8db-fb33-5a1b-a73b-0e83e5c3db08/0c4d0f98-kelp_MAX.glb"
OUT=sys.argv[-2]
...
lo=hi.copy(); lo.data=hi.data.copy(); lo.name="kelp_lo"
...
img=bpy.data.images.new("kelp_baked", BAKE_PX, BAKE_PX)
mat=bpy.data.materials.new("kelp"); mat.use_nodes=True
tree=mat.node_tree
